...
public class MedipalContract {
   ...
   * */
    public static final class HealthBioEntry implements BaseColumns {
        ...
        public final static Uri CONTENT_URI_HEALTH_BIO = Uri.withAppendedPath(MedipalContract.BASE_CONTENT, HEALTH_BIO_TABLE_NAME);
   ...
   * */
    public static final class CategoriesEntry implements BaseColumns {
        ...
        public final static Uri CONTENT_URI_CATEGORY = Uri.withAppendedPath(MedipalContract.BASE_CONTENT, CATEGORIES_TABLE_NAME);
   ...
   * */
    public static final class MedicineEntry implements BaseColumns {
        ...
        public final static Uri CONTENT_URI_MEDICINE = Uri.withAppendedPath(MedipalContract.BASE_CONTENT, MEDICINE_TABLE_NAME);
   ...
   * */
    public static final class MeasurementEntry implements BaseColumns {
        ...
        public final static Uri CONTENT_URI_MEASUREMENT = Uri.withAppendedPath(BASE_CONTENT,MEASUREMENT_TABLE_NAME);
   ...
   * */
    public static final class ConsumptionEntry implements BaseColumns {
        public static final String CONSUMPTION_TABLE_NAME = "consumption";
        public final static Uri CONTENT_URI_CONSUMPTION = Uri.withAppendedPath(BASE_CONTENT,CONSUMPTION_TABLE_NAME);
    ...
    public static final class ReminderEntry implements BaseColumns {
        ...
        public final static Uri CONTENT_URI_REMINDER = Uri.withAppendedPath(MedipalContract.BASE_CONTENT, REMINDER_TABLE_NAME);
    ...
    public static final class AppointmentEntry implements BaseColumns {
        ...
        public final static Uri CONTENT_URI_APPOINTMENT = Uri.withAppendedPath(BASE_CONTENT,APPOINTMENT_TABLE_NAME);
     ...
     * */
    public static final class IceEntry implements BaseColumns {
        public static final String ICE_TABLE_NAME = "ICE";
        public final static Uri CONTENT_URI_APPOINTMENT = Uri.withAppendedPath(BASE_CONTENT,ICE_TABLE_NAME);
